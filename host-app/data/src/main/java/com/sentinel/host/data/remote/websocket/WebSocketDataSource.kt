...
/**
 * Manages the raw OkHttp WebSocket connection.
 *
 * Thread safety:
...
class WebSocketDataSource(private val client: OkHttpClient) {
    ...
    companion object {
        private const val TAG = "Sentinel:WS"
        private const val NORMAL_CLOSURE = 1000
        private const val CLOSE_REASON = "Client disconnect"
    }
